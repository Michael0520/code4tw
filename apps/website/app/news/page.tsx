  ...
  const newsArticles = [
    {
      ...
      excerpt_en:
        "vTaiwan digital regulatory platform launches new discussion features for easier citizen participation...",
      category: "platform",
      author: "g0v 團隊",
      author_en: "g0v Team",
      date: "2024-01-15",
    ...
    },
    {
      ...
      excerpt_en:
        "Moedict online dictionary adds 1000 Hakka entries, continuing to promote Taiwan's multilingual preservation...",
      category: "project",
      author: "萌典團隊",
    ...
    },
    {
      ...
      excerpt_en:
        "Code for Taiwan participates in international civic tech exchange conference, sharing Taiwan's experience...",
    ...
    },
    {
      ...
      excerpt_en:
        "To encourage more people to participate in open source projects, we've released a detailed beginner contributor guide...",
      category: "community",
      author: "社群組",
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              <div className="flex flex-col sm:flex-row gap-4 items-center w-full sm:w-auto">
                <div className="relative w-full sm:w-80">
                  ...
                  <Input
                    placeholder={language === "zh" ? "搜尋新聞..." : "Search news..."}
                    value={searchQuery}
          ...
          <section className="py-16">
            <div className="container px-4 sm:px-6 lg:px-8">
              <div className="mx-auto max-w-4xl">
                <Badge className="mb-4">{language === "zh" ? "精選文章" : "Featured Article"}</Badge>
                <Card className="overflow-hidden border-0 bg-card/80 backdrop-blur-sm">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    <div className="aspect-video lg:aspect-square overflow-hidden">
                      <img
                        src={featuredArticle.image || "/placeholder.svg"}
                        alt={language === "zh" ? featuredArticle.title : featuredArticle.title_en}
                    ...
                    <CardContent className="p-8 flex flex-col justify-center">
                      ...
                      <h2 className="text-2xl font-bold mb-4 text-balance">
                        {language === "zh" ? featuredArticle.title : featuredArticle.title_en}
                      </h2>
                      <p className="text-muted-foreground mb-6 leading-relaxed">
                        {language === "zh" ? featuredArticle.excerpt_zh : featuredArticle.excerpt_en}
                      </p>
                      <div className="flex items-center text-sm text-muted-foreground mb-6">
                        <User className="h-4 w-4 mr-1" />
                        <span className="mr-4">
                          {language === "zh" ? featuredArticle.author : featuredArticle.author_en}
                        </span>
                        <Calendar className="h-4 w-4 mr-1" />
                        <span className="mr-4">{featuredArticle.date}</span>
                        <Clock className="h-4 w-4 mr-1" />
                        <span>
                          {featuredArticle.readTime} {language === "zh" ? "分鐘閱讀" : "min read"}
                        </span>
                      </div>
                      <Button className="w-fit group">
                        {language === "zh" ? "閱讀全文" : "Read More"}
                ...
                >
                  <div className="aspect-video overflow-hidden">
                    <img
                      ...
                      alt={language === "zh" ? article.title : article.title_en}
                  ...
                  <CardHeader className="p-6">
                    ...
                    <h3 className="text-lg font-semibold mb-2 text-balance">
                      {language === "zh" ? article.title : article.title_en}
                    </h3>
                    ...
                    <div className="flex items-center text-xs text-muted-foreground mb-4">
                      ...
                      <span className="mr-3">{language === "zh" ? article.author : article.author_en}</span>
                      <Calendar className="h-3 w-3 mr-1" />
                      <span className="mr-3">{article.date}</span>
                      <Clock className="h-3 w-3 mr-1" />
                      <span>
                        {article.readTime} {language === "zh" ? "分" : "min"}
                      </span>
                    </div>
            ...
            {filteredArticles.length === 0 && (
              <div className="text-center py-16">
                <div className="text-muted-foreground mb-4">
                  {language === "zh" ? "沒有找到符合條件的文章" : "No articles found matching your criteria"}
                </div>
                <Button
                  variant="outline"
                  onClick={() => {
            ...
            <div className="mx-auto max-w-2xl text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <Input
                  ...
                  className="flex-1"
                />
                <Button>{language === "zh" ? "訂閱" : "Subscribe"}</Button>
              </div>
            </div>
          </div>
        </section>
