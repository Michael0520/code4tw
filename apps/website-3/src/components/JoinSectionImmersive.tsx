          ...
          <div className="space-y-8">
            ...
            >
              <MagneticButton
                ...
                strength={40}
                onClick={() => window.open('https://discord.gg/pRFjDXeFyv', '_blank')}
              >
                {t('join.cta')}
              </MagneticButton>
              ...
              {!prefersReducedMotion && (
                <>
                  ...
                  {[
                    ...
                    { Icon: Database, radius: 360, duration: 30, startAngle: 180 },
                    ...
                    >
                      <div
                        className="absolute -top-5 left-1/2 -translate-x-1/2 rounded-2xl bg-[#000095] p-3 shadow-xl"
                      >
