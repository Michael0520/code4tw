  ...
  return (
    <div className="flex flex-1 w-full h-full min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-row space-x-2">
      <motion.div
        ...
        whileHover="hover"
      >
        <div className="h-full w-1/3 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
...
const SkeletonFive = () => {
  ...
  return (
    <div className="flex flex-1 w-full h-full min-h-[6rem]  bg-black/[0.2]  flex-col space-y-2">
      <motion.div
        initial="initial"
        whileHover="animate"
      >
        <div className="flex flex-row rounded-2xl border border-black/10  shadow-2xl p-2  items-start space-x-2 bg-white/10  backdrop-blur-lg">
        ...
        <div className="flex flex-row rounded-2xl border border-orange-300/70 p-2 items-center justify-end space-x-2 w-3/4 ml-auto bg-white/10 backdrop-blur-lg">
